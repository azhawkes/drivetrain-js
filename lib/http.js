...
module.exports = {
    ...
    put: function (config, url) {
        return http(config, "PUT", url);
    },
    delete: function (config, url) {
        return http(config, "DELETE", url);
    },
    options: function (config, url) {
        return http(config, "OPTIONS", url);
    },
    trace: function (config, url) {
        return http(config, "TRACE", url);
    },
    method: function (config, method, url) {
        return http(config, method, url);
    }
};
